...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="social-links d-none d-md-block">
        <a href="https://twitter.com/bprdindia?lang=en" class="twitter"><i class="bi bi-twitter"></i></a>
        <a href="https://www.facebook.com/officialBPRDIndia" class="facebook"><i class="bi bi-facebook"></i></a>
        <a href="https://www.instagram.com/bprdindia/" class="instagram"><i class="bi bi-instagram"></i></a>
        <a href="https://www.youtube.com/channel/UCGhrg_cnnGuhwXfCU16kYow" class="linkedin"><i class="bi bi-youtube"></i></i></a>
      </div>
    </div>
  </section>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" style="height:49vh;">
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        Designed by <a href="https://bootstrapmade.com/">Sarankumar J</a>
      </div>
    </div>
  </footer><!-- End Footer -->
